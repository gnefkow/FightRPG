...
// INITIATE GAME:
  ...
  function initiateGame(){   
    ...
    //Proceed to choosing Player and Opponent Characters:
      cardClicker();
  };
    
    

// CHOOSE PLAYER AND OPPONENT CHARACTERS

  // Creates an array called characterCards
    var characterCards = document.getElementsByClassName('characterCard');

  // Loops through that array to make cards click-able
    function cardClicker (){ 
      for (var i = 0; i < characterCards.length; i++){
      characterCards[i].onclick = cardPicker;
      };
    };
    
   // Selects Player and Opponent cards based on user clicks: 
    function cardPicker(){ 
